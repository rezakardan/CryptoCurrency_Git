...
import com.example.cryptoapp.databinding.ItemCoinsMarketBinding
import com.example.cryptoapp.utils.base.BaseDiffUtils
...
class CoinsAdapter @Inject constructor(@ApplicationContext private val context: Context) :
    ...
    private var items = emptyList<ResponseCoinsMarket.ResponseCoinsMarketItem>()
    ...
    inner class ViewHolder(private val binding: ItemCoinsMarketBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(item: ResponseCoinsMarket.ResponseCoinsMarketItem) {
            binding.apply {
                //Text
    ...
    private var onItemClickListener: ((ResponseCoinsMarket.ResponseCoinsMarketItem) -> Unit)? = null

    fun setOnItemClickListener(listener: (ResponseCoinsMarket.ResponseCoinsMarketItem) -> Unit) {
        onItemClickListener = listener
    }

    fun setData(data: List<ResponseCoinsMarket.ResponseCoinsMarketItem>) {
